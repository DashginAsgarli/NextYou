        ...
        <div>
            <div className="login-container">
                ...
                <div className="login-column-two">
                    ...
                    <div className="login-h2-d">Yeni hesab yaradın</div>
                    <form>
                        ...
                        <div className="login-logo1">
                            <input type="password" placeholder="Parolu yenidən daxil edin" required />
                            <i class="bi bi-lock-fill"></i>
                        </div>
                        <div className="login-chec-p">
                            <div className="login-chec">
                                <input type="checkbox" />
                                <span>İstifadə şərtlərini qəbul edirəm</span>
                            </div>
                        </div>
                        <button className="login-button">Qeydiyatı tamamla</button>
                    </form>
