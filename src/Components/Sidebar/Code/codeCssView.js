...
function CssLessonView({ lesson, onBack, isCompleted, onComplete }) {
  ...
  return (
    <div className="html-tutorial-lesson-view css-tutorial-container">
      ...
      <div className="html-tutorial-lesson-detail">
        <div className="html-tutorial-lesson-header-detail">
          ...
          <div className="html-tutorial-lesson-meta-detail">
            ...
            <span className="meta-item">
              <i className="bi bi-filetype-css"></i> CSS Dərsi
            </span>
            <span className="meta-item">
        ...
        <div className="html-tutorial-lesson-sections">
                  ...
                  {lesson.content.examples.map((example, index) => (
                    <div key={index} className="code-example-container">
                      ...
                      <pre className="html-tutorial-code-block">
                        <code className="language-css">{example}</code>
                      </pre>
                    </div>
                  ))}
                </div>
          ...
          {lesson.content.usage && (
            <section className="html-tutorial-section">
              <div className="section-header">
                <i className="bi bi-lightbulb-fill section-icon"></i>
                <h3 className="section-title">İstifadə Nümunələri</h3>
              </div>
              <div className="section-content">
                <p>{lesson.content.usage}</p>
              </div>
            </section>
          )}

          {lesson.content.properties && lesson.content.properties.length > 0 && (
            <section className="html-tutorial-section">
              <div className="section-header">
                <i className="bi bi-list-check section-icon"></i>
                <h3 className="section-title">CSS Xüsusiyyətləri</h3>
              </div>
              <div className="section-content">
                <div className="css-properties-grid">
                  {lesson.content.properties.map((property, index) => (
                    <div key={index} className="css-property-card">
                      <div className="property-header">
                        <code className="property-name">{property.name}</code>
                        <span className="property-type">{property.type}</span>
                      </div>
                      <p className="property-desc">{property.description}</p>
                      {property.example && (
                        <pre className="property-example">
